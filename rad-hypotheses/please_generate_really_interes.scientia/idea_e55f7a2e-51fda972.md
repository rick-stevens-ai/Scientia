...
**Title**: SUMO-RPA32 Sequesters Hippo Kinase MST1 at Stalled Forks to Enable Damage-Tolerance Cycling

**Key Idea**: Radiation-specific SUMO2 conjugation on RPA32 binds the SIM of MST1, trapping the kinase at replication forks, suppressing LATS1 and freeing YAP to drive proliferation.

**Paragraph**: SUMO-proteomics shows RPA32-K164/K185 conjugation peaks 20 min post-IR. SIM-mutant MST1 fails to co-localise with RPA; LATS1-T1079 phosphorylation drops 60 % in WT but not SIM-mutant cells, elevating TEAD-luciferase.

**Approach**: (i) SUMO-IP mass-spec; (ii) MST1-SIMmut rescue; (iii) YAP localisation & TEAD reporter; (iv) cell-cycle profiling; (v) sensitivity to gemcitabine.

**Key References**: [Vyas 2013]; [Yu 2015 Cell]; [Harvey 2013]; [Tang 2019]  
Refinement Notes: Mapped SUMO sites, incorporated Hippo-DDR reference [Yu 2015], addressed causal link to YAP.

────────────────────────────────────────
REFINED IDEA 6  (origin: original Idea 6)
────────────────────────────────────────
