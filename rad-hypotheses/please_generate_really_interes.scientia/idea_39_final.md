...
ATM-phosphorylated SRSF10 splicing favours cGAS-ΔN lacking the DNA-binding domain; cGAS-ΔN binds HP1α, elevating H3K9me3 around breaks, masking lesions from checkpoint sensors.

## Paragraph Summary

RNA-seq indicates 3-fold rise of cGAS-ΔN isoform post-IR. GST-pull-down maps HP1α chromoshadow interaction to cGAS residues 145-210. Overexpression reduces 53BP1 foci by 40 % and increases mutation burden. siRNA against cGAS-ΔN restores checkpoint activation.
...
(i) Isoform-specific RT-qPCR; (ii) HP1α interaction assays; (iii) ChIP-seq for H3K9me3; (iv) mutation accumulation via Duplex-seq; (v) SRSF10 phospho-mutant rescue.
