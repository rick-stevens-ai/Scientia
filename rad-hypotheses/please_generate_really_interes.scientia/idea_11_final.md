# Final Report: Idea 11

## Title

Fatty Acid Synthase (FASN) Scaffolds 53BP1 to Lipid Microdomains in the Nucleus

## One Sentence Summary

Radiation activates nuclear FASN, whose palmitoylation activity anchors 53BP1 to chromatin lipid microdomains, altering DDR signaling and promoting survival.

## Paragraph Summary

Nuclear lipid synthesis is emerging as a regulatory layer. We hypothesize that phosphorylation of FASN at Ser2221 post-IR drives its import where it palmitoylates histone H2A, creating lipid micro-patches that preferentially recruit 53BP1, skewing repair toward NHEJ and providing a metabolic-repair axis favoring oncogenesis.
...
(i) Nuclear FASN activity assay; (ii) acyl-biotin exchange to detect palmitoylated H2A; (iii) FASN inhibitors on DSB repair pathway choice; (iv) transformation assays in 3D culture.
