...
**Key Idea**: : Short, intermittent dosing of pradigastat depletes macrophage lipid droplets—Mtb’s carbon source—while permitting host lipid recovery between pulses.

**Paragraph**: : PET-CT [Knight 2021] shows lipid droplets repopulate only after 48 h; 24-h on / 48-h off maintains bacteriostatic pressure yet normalises serum triglycerides [Singh 2017].

**Approach**: : (i) Lipidomics to refine pulse schedule; (ii) Mtb kill assays in DGAT1-KO macrophages; (iii) C3HeB/FeJ mouse therapy; (iv) systemic lipid & cytokine panels.

**Key References**: : Knight 2021; Villeneuve 2020; Singh 2017; Kim 2010; Russell 2019.  
Refinement Notes : PET-CT-guided schedule tests “recovery window” concern; full lipid panels added.
...
I’m ready to generate the tournament-style comparison, but I need a second idea (Idea B) to score alongside the DGAT1-inhibition concept (Idea A).  
Please provide another candidate therapy so I can complete the 20-criterion evaluation in the required format.
