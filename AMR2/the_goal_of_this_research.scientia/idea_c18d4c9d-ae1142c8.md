# Idea 104: Evolution Log

**Unique ID:** c18d4c9d-ae1142c8

## New Idea (Significant Change) (Round 4)

**Timestamp:** 2025-05-07 14:42:44
...
**Approach**: (i) Heavy-atom substitution series to maximise singlet-oxygen yield; (ii) optical-dosimetry validation in ex-vivo human lung; (iii) airway-organoid TEER & LDH assays; (iv) murine illumination model; (v) 16S rRNA profiling for microbiome impact.
...
**Key Idea**: Allenamide adducts targeting enzyme Cyp125 will irreversibly block the first oxidative step in cholesterol breakdown, starving Mtb in host macrophages.

**Paragraph**: Cholesterol is indispensable carbon source for intracellular Mtb [Yang 2019]. Cyp125’s active cysteine can undergo Michael addition with allenamide electrophiles, an unexplored tactic.

**Approach**: (i) Enzyme kinetics with recombinant Cyp125; (ii) macrophage infection under cholesterol media; (iii) evaluate synergy with isoniazid in mice; (iv) metabolomic confirmation of pathway blockade.

**Key References**: [Yang 2019] cholesterol metabolism in TB; [Cheng 2021] allenamide reactivity in covalent drugs.
...
I’m ready to score two ideas side-by-side, but only one idea has been supplied.  
Could you please provide a second idea (Idea B) so I can complete the 20-criterion comparison in the required format?
