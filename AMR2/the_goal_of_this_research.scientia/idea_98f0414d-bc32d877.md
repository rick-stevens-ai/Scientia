...
**Key Idea**: : A 37 °C-optimal Clostridium pAgo packaged in host-range-tuned PICIs nicks essential DNA and degrades mRNA, killing pathogens in the gut.

**Paragraph**: : PICIs integrate only into prophage-carrying E. coli pathotypes, sparing commensals [Cao 2019]; off-target mapping uses SMRT sequencing.

**Approach**: : (i) Guide cocktail; (ii) PICI host-range optimisation; (iii) gut colonisation clearance; (iv) microbiome impact.

**Key References**: : Swarts 2017; Doxzen 2021; Cao 2019; Enghiad 2017; Rauch 2020.  
Refinement Notes : Host-range tuning & SMRT off-target mapping tackle specificity concern.
