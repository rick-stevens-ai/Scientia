...
S. aureus Cyclic-di-AMP Export Blockers to Induce Toxic Accumulation

## One Sentence Summary

Inhibiting the CdaA exporter will elevate intracellular c-di-AMP, causing cell-wall stress and lysis in S. aureus.

## Paragraph Summary

C-di-AMP homeostasis is vital; excess triggers ion imbalance and DNA damage [Whiteley 2019]. Exporters remain uncharacterized as drug targets, presenting a fresh vulnerability.
...
(i) Identify transporter via transposon sequencing; (ii) screen membrane-permeable polyphenols for efflux inhibition; (iii) quantify c-di-AMP by LC-MS; (iv) synergy testing with β-lactams.
...
- **Opoku 2022**: Relevant to the core concepts of this idea, providing theoretical foundation and empirical evidence.
