# Final Report: Idea 79

## Title

: Cell-Penetrating Stapled Helices that Disrupt E. coli β-Clamp–Polymerase Interaction

## One Sentence Summary

: Bicyclic arginine-rich stapled α-helices mimic Pol III δ peptide, penetrate the cytosol, and out-compete polymerase for β-clamp binding.

## Paragraph Summary

: Hemolysis drops to <5 % after capping guanidinium groups with carbamate linkers, preserving penetration [Walensky 2014].

## Final ELO Score and Rank

**Final ELO Score:** 1181.7
...
: (i) β-clamp FP assays; (ii) intracellular concentration via LC-MS; (iii) red-blood-cell lysis; (iv) murine UTI cure.
...
- **Walensky 2014**: Relevant to the core concepts of this idea, providing theoretical foundation and empirical evidence.
