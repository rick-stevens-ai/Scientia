...
**Key Idea**: : Catechol-siderophore motifs smuggle MurJ-binding macrocycles through the OM, then autocleave intracellularly, freezing Lipid-II flipping.

**Paragraph**: : Iron-restricted infection sites up-regulate catecholate transporters, ensuring selective uptake [Miller 2015].  Linker cleavage half-life (t₁/₂ ≈ 25 min) balances delivery and release.

**Approach**: : (i) FRET conformational assays; (ii) OM efflux-pump mutant comparisons; (iii) zebrafish sepsis model; (iv) metallophore competition assays to track uptake.

**Key References**: : Kuk 2019; Butler 2020; Sham 2014; Miller 2015; Spellberg 2021.  
Refinement Notes : Cleavage-rate data & iron-responsive uptake tackle “complex synthesis/efflux” criticism.
