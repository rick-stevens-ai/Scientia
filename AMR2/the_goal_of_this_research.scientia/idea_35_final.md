# Final Report: Idea 35

## Title

Mapping and Blocking S. aureus c-di-AMP Export to Induce Intracellular Poisoning

## One Sentence Summary

CRISPRi-guided chemogenomic mapping identifies the elusive c-di-AMP exporter (CdaE), enabling discovery of selective inhibitors that synergise with β-lactams.

## Paragraph Summary

Tn-seq under high-c-di-AMP stress recently highlighted CdaE as a unique MFS transporter [Huynh 2022]. Inhibiting CdaE causes ion-homeostasis collapse and β-lactam hypersensitivity without affecting eukaryotic cyclic-nucleotide handling.

## Final ELO Score and Rank

**Final ELO Score:** 1200.7
...
(i) Generate Δpde strains to minimise redundancy; (ii) split-luciferase c-di-AMP reporters for HTS; (iii) lipid nanoparticle formulation of lead compound to bypass efflux; (iv) murine thigh co-therapy with oxacillin.
