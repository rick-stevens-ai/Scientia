# Final Report: Idea 57

## Title

Ferrichrome-Oxazolidinone Conjugates with Self-Immolative Linkers for ESX-3 Uptake in Mtb

## One Sentence Summary

Boronic-ester self-immolative linkers cleave upon intracellular ROS, releasing oxazolidinone after ESX-3-mediated import, preventing efflux and down-regulation escape.

## Paragraph Summary

ESX-3 import is up-regulated under host iron restriction, enhancing selectivity [Arnold 2021]. ROS-triggered release ensures activation only inside bacilli.

## Final ELO Score and Rank

**Final ELO Score:** 1193.7
...
(i) Fe-competition and uptake assays; (ii) macrophage infection; (iii) chronic TB efficacy; (iv) resistance gene expression profiling.
