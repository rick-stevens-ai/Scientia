...
• Added HDX-MS to validate pocket lifetime.  
• Integrated BDQ-resistant clinical isolates.  
• Added mitochondrial off-target panel.  
• New citations Guo 2021, Cournia 2020.

───────────────────

Idea 2  (refines original “Pneumococcal Teichoic-Acid Glycosyl-Transferase Suicide Substrate Design”)
...
Criterion 7 (Predictive Power): Idea A = 6, Idea B = 6
Criterion 8 (Cross-domain Impact): Idea A = 5, Idea B = 5
Criterion 9 (Novelty): Idea A = 7, Idea B = 7
