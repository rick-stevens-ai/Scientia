# Final Report: Idea 16

## Title

Hybrid Endolysin-Outer-Membrane-Permeabilizer Fusion Against E. coli

## One Sentence Summary

Fusing murein endopeptidase LysEF-cps with cationic amphipathic peptides will bypass outer membrane and lyse multidrug-resistant E. coli.

## Paragraph Summary

Endolysins are potent but limited by OM barrier [Thomson 2020]; engineered fusions overcome this without polymyxin toxicity.
...
(i) Construct genetic fusions; (ii) measure lytic activity on permeabilized vs. intact cells; (iii) serum stability testing; (iv) murine bacteremia cure rate.
...
- **Rodriguez-Rojas 2019**: Relevant to the core concepts of this idea, providing theoretical foundation and empirical evidence.
- **Thomson 2020**: Relevant to the core concepts of this idea, providing theoretical foundation and empirical evidence.
