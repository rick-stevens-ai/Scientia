# Final Report: Idea 69

## Title

: Dopamine-Chelated Fe-Porphyrin MOF Nanozymes for Safe In-Situ H₂O₂ Generation in Airway Biofilms

## One Sentence Summary

: Dopamine grafting buffers labile Fe²⁺, allowing ZIF-8-porphyrin nanozymes to create bactericidal peroxide bursts while sparing host epithelium.

## Paragraph Summary

: Dopamine’s catechol lowers Fe²⁺ leakage by 70 % and slightly delays Fenton turnover, balancing efficacy with safety [Fan 2022].  PEG-surface improves mucus penetration and reduces immunogenicity.

## Final ELO Score and Rank

**Final ELO Score:** 1203.0
...
: (i) Amplex-Red + electron-spin-resonance to quantify ROS; (ii) airway organoid viability; (iii) dual-species biofilm eradication; (iv) Fe-speciation mass-balance studies.
