...
**Key Idea**: : NfsA-specific seleno-azide prodrugs liberate bactericidal selenols, while timed dimercaprol administration scavenges leaked selenium, preserving host safety.

**Paragraph**: : NfsA expression is 12-fold higher in pathogenic E. coli versus commensals [Greene 2018].  Dimercaprol’s short t½ allows a 2-h safety window that does not quench intracellular selenols.

**Approach**: : (i) Prodrug SAR for NfsA preference; (ii) glutathione and dimercaprol competition kinetics; (iii) murine UTI model with antidote timing matrix; (iv) microbiome 16S profiling.

**Key References**: : Paglia 2018; Huang 2019; Nakamura 2020; Greene 2018; Tsai 2021.  
Refinement Notes : Explicit temporal-separation schedule mitigates “dimercaprol timing” issue.
