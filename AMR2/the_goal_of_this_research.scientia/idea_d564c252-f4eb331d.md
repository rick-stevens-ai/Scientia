...
**Title**: Inhalable Metal-Phenolic Network Micro-Particles Encapsulating Broad-Spectrum Quorum-Quenchers

**Key Idea**: Co-encapsulation of AiiA lactonase and thiolactone AIP inhibitor delivers dual quorum interference against Gram-negative AHL and S. aureus AIP systems in lung infections.

**Paragraph**: Metal-phenolic shells protect enzymes and small molecules, releasing them in mucosal pH ≈6.5 [Zhou 2021].

**Approach**: (i) Synergy biofilm assays; (ii) aerosol dispersion; (iii) guinea-pig mixed infection; (iv) cytokine profiling.

**Key References**: Grandclément 2016; Dong 2019; Ejim 2011; Zhou 2021.  
Modifications: Added AIP inhibitor to cover Gram-positive quorum sensing, new refs.
...
Criterion 8 (Cross-domain Impact): Idea A = 7, Idea B = 1  
