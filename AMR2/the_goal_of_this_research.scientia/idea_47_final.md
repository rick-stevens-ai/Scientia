# Final Report: Idea 47

## Title

Photo-Heme Analogues for SCV Re-Sensitisation with NIR Light Guidance

## One Sentence Summary

Near-infrared (780 nm) activatable zinc-porphyrin prodrugs restore ETC in S. aureus SCVs at wound sites, enhancing aminoglycoside uptake.

## Paragraph Summary

780 nm penetrates tissue to 6 mm, covering skin and soft-tissue infections [St Denis 2013]. Nanoliposome delivery confines photosensitiser to infection foci, reducing host phototoxicity.

## Final ELO Score and Rank

**Final ELO Score:** 1191.9
...
(i) ETC flux measurement; (ii) aminoglycoside MIC shift; (iii) porcine burn-wound model; (iv) host tissue ROS assays.
...
- **St Denis 2013**: Relevant to the core concepts of this idea, providing theoretical foundation and empirical evidence.
