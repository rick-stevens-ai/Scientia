...
Globomycin-Inspired Dibasic LspA Inhibitors with Reduced Serum Binding

## One Sentence Summary

Introducing zwitterionic phosphonate heads into di-basic lipopeptidomimetics retains LspA potency while cutting serum albumin affinity ten-fold.

## Paragraph Summary

Cryo-EM indicates a basic pocket tolerating phosphonate substitution that does not exist in human signal peptidase [Kurokawa 2020].

## Final ELO Score and Rank

**Final ELO Score:** 1167.3
...
(i) HSA binding assays; (ii) time-kill curves in serum; (iii) zebrafish embryo toxicity; (iv) polymicrobial lung-infection model.
...
- **Kurokawa 2020**: Relevant to the core concepts of this idea, providing theoretical foundation and empirical evidence.
