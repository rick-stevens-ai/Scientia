...
**Key Idea**: Dopamine-grafted Fe-porphyrin ZIF-8 MOFs sequester iron while catalysing Fenton reactions, producing localised H₂O₂ that surpasses bacterial defences yet spares epithelium.

**Paragraph**: Dopamine chelation buffers free Fe²⁺ leakage, mitigating bacterial iron acquisition and host toxicity [Fan 2022]. Mucus-penetrating PEGylation improves biofilm penetration.

**Approach**: (i) Determine iron-release kinetics; (ii) ROS measurement in airway organoids; (iii) dual-species biofilm eradication; (iv) airway-surface-liquid pH influence study.

**Key References**: Zhang 2022; Fan 2022; Van Acker 2014; Goymer 2019.  
Modifications: Added iron-chelating dopamine, pH modulation, new citations.
...
Criterion 5 (Symmetry Properties): Idea A = 4, Idea B = 3  
...
Criterion 12 (Energy Efficiency): Idea A = 6, Idea B = 8  
Criterion 13 (Conservation Laws): Idea A = 5, Idea B = 6  
Criterion 14 (Dimensional Analysis): Idea A = 4, Idea B = 3  
Criterion 15 (Quantum Properties): Idea A = 3, Idea B = 2  
Criterion 16 (Computational Complexity): Idea A = 3, Idea B = 2  
Criterion 17 (Statistical Mechanics): Idea A = 4, Idea B = 4  
Criterion 18 (Geometric Structure): Idea A = 7, Idea B = 3  
Criterion 19 (Phase Transitions): Idea A = 3, Idea B = 2  
