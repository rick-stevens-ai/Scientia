...
def get_supervisor_agent_prompt():
    ...
    return (
        ...
        "Coordinate the workflow by summarizing outputs from generation, evolution, reflection, proximity checks, "
        "and tournaments. Provide clear guidance and context for each subsequent phase, ensuring consistency and coherence."
    )
##############################################################################
