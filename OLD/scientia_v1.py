...
MODEL_ID       = "meta-llama/Llama-3.3-70B-Instruct"  # whichever model you prefer
...
if __name__ == "__main__":
    # Example usage
    user_research_goal = "Develop an approach to use AI and simulation to explore the origin of life."
